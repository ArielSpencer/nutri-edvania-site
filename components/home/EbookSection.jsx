...
const EbookSection = () => {
  const currentEbook = {
    ...
    image: "/assets/ebook/lancheira-saudavel.png",
  ...
  return (
    <section className="flex flex-col items-center text-center p-16 bg-background text-primary">
      ...
      <div className="mb-12 uppercase">
        <p className="text-secondary font-semibold">E-book</p>
        <h2 className="text-3xl text-black font-bold">{currentEbook.title}</h2>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-30 lg:gap-20 xl:gap-0 items-center w-full xl:w-[80vw]">
        ...
        <div className="grid grid-cols-1 gap-4 col-span-3 lg:col-span-1">
          {currentEbook.highlights.slice(0, 4).map((highlight, index) => (
            <div
              key={index}
        ...
        <div className="relative flex justify-center col-span-3 lg:col-span-1">
          <div className="relative w-full h-full">
            ...
            <div className="absolute inset-0 flex items-center justify-center">
              ...
              <div className="absolute w-[300px] h-[300px] rounded-full border-[20px] border-[#FCEFE7]">
                <div className="absolute inset-0 rounded-full border-[20px] border-[#FADDCC]">
                  <div className="relative w-full h-full">
                    <Image
        ...
        <div className="grid grid-cols-1 gap-4 col-span-3 lg:col-span-1">
          {currentEbook.highlights.slice(4, 8).map((highlight, index) => (
            <div
              key={index}
              className={`grid grid-cols-1`}
            >
